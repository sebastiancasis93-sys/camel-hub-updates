...
if rootWidget then
    ...
    AthalarModules.Containers = {
      isOn = function() return config.enabled == true end,
      setOn = function() config.enabled = true; renameContui.title:setOn(true) end,
      setOff = function() config.enabled = false; renameContui.title:setOn(false) end
    }
