...
Panel
  ...
  AthalarModules.Conditions = {
    isOn = function() return config.enabled == true end,
    setOn = function() config.enabled = true; ui.title:setOn(true); vBotConfigSave("heal") end,
    setOff = function() config.enabled = false; ui.title:setOn(false); vBotConfigSave("heal") end
  }
